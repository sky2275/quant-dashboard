...
def generate_html(market, us_market, flow_data, limit_up, transmissions, pos_rows, total_pnl):
    ...
    for i, item in enumerate(stock_flow_top100[:10]):
        ...
        <tr>
            ...
            <td><div class="heat-bar" style="width:{heat}%;"></div></td>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .header {{
            ...
            padding: 20px 0 16px 0; border-bottom: 1px solid var(--border-color);
        ...
        .header .status-badge {{
            background: #1b3a2a; color: #81c784; padding: 4px 14px;
            border-radius: 20px; font-size: 11px; display: flex; align-items: center; gap: 6px;
        }}
        ...
        .card-title .badge {{
            ...
            padding: 0 10px; border-radius: 12px; font-size: 10px;
        }}
        .card-title .click-hint {{
            color: var(--text-muted); font-size: 10px; font-weight: 400;
            margin-left: auto; display: flex; align-items: center; gap: 4px;
        }}
        .card-title .click-hint i {{ font-size: 12px; }}
        ...
        .market-group .group-title {{
            color: var(--text-secondary); font-size: 11px; font-weight: 600;
            margin-bottom: 8px; letter-spacing: 0.5px;
        }}
        .market-row {{ display: flex; flex-wrap: wrap; gap: 6px 14px; }}
        .market-item {{
        ...
        .sentiment-fill {{
            ...
            background: linear-gradient(90deg, #e57373, #ffd54f, #81c784);
            width: {up_ratio:.0f}%;
        }}
        ...
        .rank-badge {{
            background: var(--border-color); padding: 2px 8px;
            border-radius: 12px; font-size: 10px; color: var(--text-secondary);
        }}
        .sector-tag {{
            background: rgba(79, 195, 247, 0.12); color: var(--accent-blue);
            padding: 2px 10px; border-radius: 12px; font-size: 10px;
        }}
        .heat-bar {{
            height: 4px; background: linear-gradient(90deg, #4fc3f7, #81c784);
        ...
        .task-list li {{
            padding: 5px 0; font-size: 13px; color: #c8d0dc;
        ...
        <div class="card card-full" onclick="openModal('market')">
            ...
            <div class="market-grid">
                <div class="market-group">
                    <div class="group-title"><i class="fas fa-flag"></i> A股</div>
                ...
                <div class="market-group">
                    <div class="group-title"><i class="fas fa-flag-usa"></i> 美股 (隔夜)</div>
                    <div class="market-row">
                        ...
                        <div class="market-item"><span class="label">七巨头</span><span class="value red">{us_market['tech_7']['change']:+.2f}%</span></div>
...
const modalData = {{
    'market': {{
        ...
        content: `
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                <div>
                    <h3 style="color:#81c784;"><i class="fas fa-flag"></i> A股</h3>
                ...
                <div>
                    <h3 style="color:#4fc3f7;"><i class="fas fa-flag-usa"></i> 美股 (隔夜)</h3>
            ...
            <div style="margin-top:16px;padding:12px;background:rgba(255,255,255,0.03);border-radius:8px;">
                <div style="color:#ffd54f;"><i class="fas fa-lightbulb"></i> 核心解读</div>
    ...
    'transmission': {{
        ...
        content: `
            ...
            <div style="margin-top:16px;padding:12px;background:rgba(255,255,255,0.03);border-radius:8px;">
                <div style="color:#ffd54f;"><i class="fas fa-lightbulb"></i> 策略建议</div>
    ...
    'positions': {{
        ...
        content: `
            ...
            <div style="margin-top:16px;padding:12px;background:rgba(255,255,255,0.03);border-radius:8px;">
                <div style="color:#ffd54f;"><i class="fas fa-chart-line"></i> 总盈亏: {total_pnl:+,.0f}</div>
            </div>
        `
    }},
    'judgment': {{
        ...
        content: `
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                <div style="background:rgba(255,255,255,0.02);border-radius:8px;padding:14px;">
                    <div style="color:#81c784;font-size:14px;"><i class="fas fa-check-circle"></i> 主线方向</div>
                ...
                <div style="background:rgba(255,255,255,0.02);border-radius:8px;padding:14px;">
                    <div style="color:#e57373;font-size:14px;"><i class="fas fa-exclamation-triangle"></i> 风险提示</div>
                    <ul style="list-style:none;padding:0;margin-top:8px;">
            ...
            <div style="margin-top:14px;padding:14px;background:rgba(79,195,247,0.06);border-radius:8px;border:1px solid rgba(79,195,247,0.1);">
                <div style="color:#4fc3f7;font-size:14px;"><i class="fas fa-tasks"></i> 核心任务</div>
                <ul class="task-list">
                    <li>永安行反抽18.50以上继续清仓</li>
                    <li>长电科技/征和工业持有，不恐慌割肉</li>
                    <li>北京君正143支撑，跌破则减仓</li>
...
def main():
    ...
    print(f"✅ 优化版看板已生成: index.html")
    print(f"📊 总盈亏: {total_pnl:+,.0f}")
    print(f"💡 新增优化: 情绪温度计 | 热力条 | 收益柱 | Font Awesome 图标")
